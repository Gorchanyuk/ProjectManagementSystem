...
import digital.design.management.system.dao.EmployeeJdbcDAO;
import digital.design.management.system.dao.ProjectJdbcDAO;
...
public class ProjectManagementSystem implements CommandLineRunner {

    private final EmployeeJdbcDAO searcDao;
    private final ProjectJdbcDAO dao;

    public ProjectManagementSystem(EmployeeJdbcDAO searcDao, ProjectJdbcDAO dao) {
        this.searcDao = searcDao;
        this.dao = dao;
    }
